...
(() => {
  ...
  const dictionaries = {
    vi: {
      ...
      "home.card.cv.meta": "Sẽ dùng chung tài khoản",
      "home.card.cv.cta": "Xem trước",
      ...
      "home.card.jobs.meta": "Tìm việc cơ bản dự kiến miễn phí",
      "home.card.jobs.cta": "Xem trước",
    ...
    en: {
      ...
      "home.card.cv.meta": "Will use the same account",
      "home.card.cv.cta": "Preview",
      ...
      "home.card.jobs.meta": "Basic job search is planned to be free",
      "home.card.jobs.cta": "Preview",
    ...
    zh: {
      ...
      "home.card.cv.meta": "將共用同一帳號",
      "home.card.cv.cta": "預覽",
      "home.card.jobs.title": "適合的工作",
      "home.card.jobs.desc": "篩選職缺並比對目前能力與職務需求。",
      "home.card.jobs.meta": "基礎找工作功能預計免費",
      "home.card.jobs.cta": "預覽",
